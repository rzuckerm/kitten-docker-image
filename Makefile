KITTEN_VERSION := $(shell cat KITTEN_VERSION)
KITTEN_DEPS := $(wildcard KITTEN_*)
DOCKER_TAG_PREFIX := rzuckerm/kitten:$(KITTEN_VERSION)
...
$(META_BUILD_TARGET): Dockerfile Makefile $(KITTEN_DEPS)
